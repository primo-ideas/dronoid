...
pub fn run_game(
    ...
    let exit = App::new()
        ...
        .insert_resource(resource::Controls(controls))
        .insert_resource(resource::TransportStopper(transport_stopper_tx))
        .insert_resource(resource::NewPlayerReceiver(new_player_rx))
        .insert_resource(resource::Players::default())
        .insert_resource(resource::TerrainGenerator::new(&rules))
        .insert_resource(resource::Rules(rules))
